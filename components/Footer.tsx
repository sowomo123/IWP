    ...
    <footer className="mt-0">
      ...
      <section className="bg-gray-100 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-8 text-[#27B0F5]">
          ...
          <div className="relative flex items-center justify-center">
            ...
            <div className="flex justify-center items-center gap-6 max-w-6xl mx-12 overflow-hidden">
              {colleges.slice(currentIndex, currentIndex + 5).map((college, index) => (
                <div key={index} className="flex flex-col items-center">
                  ...
                  <p className="text-xs text-center text-gray-600 mt-1 max-w-[100px]">
                    {college.name}
                  </p>
                </div>
              ))}
      ...
      <section className="bg-[#87CEEB] py-8 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4 items-center">
                <Link
                  href="https://ims.rub.edu.bt/public/auth/view-login"
                ...
                <Link
                  href="https://www.rub.edu.bt/index.php/sitemap.xml"
                  className="text-gray-700 hover:text-gray-900 transition-colors text-sm"
                >
                  Sitemap
                </Link>
                <Link
                  href="https://www.rub.edu.bt/index.php/faq/"
                  className="text-gray-700 hover:text-gray-900 transition-colors text-sm"
                >
                  FAQ
                </Link>
